...
const EditAdminCase = () => {
  const { doctors, agents, dummyTests, dummyPanels, selectedBranch, adminToken, successToast, errorToast } =
...
const [caseData, setCaseData] = useState(null);
  ...
  useEffect(() => {
    const fetchCase = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/cases/admin/${id}`, {
