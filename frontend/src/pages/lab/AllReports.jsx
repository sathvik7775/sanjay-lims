  ...
  const handleSearch = () => {
    ...
    if (filters.patient) {
      results = results.filter((r) =>
        r.patient.firstName.toLowerCase().includes(filters.patient.toLowerCase())
      );
    }
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-6">
        ...
        <select name="test" value={filters.test} onChange={handleFilterChange} className="border px-3 py-2 rounded-md text-sm">
