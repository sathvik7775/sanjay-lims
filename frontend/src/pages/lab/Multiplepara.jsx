...
const Multiplepara = () => {
  ...
  return (
    <div className="w-full p-8 bg-white rounded-lg shadow-lg mt-10">
      <h1 className="text-2xl font-semibold text-center mb-6">New Test (Multi Parameter)</h1>
  ...
  {formData.parameters.map((parameter, index) => (
    <div key={parameter.id} className="grid grid-cols-6 gap-4 mb-4 p-4 border border-gray-200 rounded-md bg-gray-50">
        ...
        <div className="grid grid-cols-2 gap-4 mt-6">
          <div className="col-span-1">
            ...
            <input
              ...
              id="method"
              name="method"
              value={formData.method}      // <-- add this
  onChange={handleTestDetailsChange}
              className="w-full p-2 border border-gray-300 rounded-md"
            />
          </div>
          <div className="col-span-1">
            ...
            <input
              ...
              id="instrument"
              name="instrument"
              value={formData.instrument}  // <-- add this
  onChange={handleTestDetailsChange}
              className="w-full p-2 border border-gray-300 rounded-md"
            />
          </div>
